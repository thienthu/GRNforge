...
import pickle
import gzip
# Import the custom EnhancerGRN class. Make sure it matches the same version as the one used to create the base GRN !
...
if __name__ == '__main__':
    ...
    expression_adata   = ad.read_h5ad(data_folder   + 'pbmc_granulocyte_sorted_10k_gex_molecule_info_filtered_mg_mc_gc_mt_tc_normalized_log1p.h5ad')
    geneactivity_adata = ad.read_h5ad(result_folder + 'PBMC10k_gene_activity_matrix_normalized.h5ad')
